...
List<Soru> meslekSorulari = [
  Soru(
    soruKoku: 'doktor.mp3',
    soruResmi:
        'https://cdn.pixabay.com/photo/2018/10/05/05/19/stethoscope-3725131_960_720.png',
    dogruCevap:
    ...
    secenek3:
        'https://cdn.pixabay.com/photo/2013/07/12/17/01/firefighter-151712_960_720.png',
    secenek4:
        'https://cdn.pixabay.com/photo/2020/12/31/12/28/cook-5876388_1280.png',
  ),
  Soru(
    soruKoku: 'itfaiyeci.mp3',
    soruResmi:
        'https://cdn.pixabay.com/photo/2012/04/18/22/24/fireman-38083__340.png',
    dogruCevap:
        'https://cdn.pixabay.com/photo/2013/07/12/17/01/firefighter-151712_960_720.png',
    secenek1:
        'https://cdn.pixabay.com/photo/2020/05/25/03/37/doctor-5216835_960_720.png',
  ...
  Soru(
    soruKoku: 'pilot.mp3',
    soruResmi:
        'https://cdn.pixabay.com/photo/2013/07/13/12/18/boeing-159589__340.png',
    dogruCevap:
        'https://cdn.pixabay.com/photo/2013/07/13/12/40/pilot-160084_1280.png',
    secenek1:
        'https://cdn.pixabay.com/photo/2013/07/13/12/40/pilot-160084_1280.png',
    secenek2:
        'https://cdn.pixabay.com/photo/2013/07/13/10/17/barber-156940_1280.png',
